...
dnf install bat btop curl fish duf exa gnome-shell-extension-apps-menu gnome-shell-extension-system-monitor git neovim openssl python3 python3-pip tmux util-linux-user wget -y
